...
SCIPP = MultipleTestResults(in_dir + 'SCIPP/', scipp_files, 'SCIPP')

files = ['ABC130_M14_Hyb3_RC_2529_2.txt', 'ABC130_M14_Hyb4_RC_2529_2.txt']
BNL_scipp_config_15degrees = MultipleTestResults(in_dir + 'BNL/scipp_config_15degrees/', files, 'scipp_config_15degrees')

files = ['ABC130_M14_Hyb3_RC_2524_1.txt', 'ABC130_M14_Hyb4_RC_2524_1.txt']
BNL_scipp_config_17degrees = MultipleTestResults(in_dir + 'BNL/scipp_config_17degrees/', files, 'scipp_config_17degrees')

files = ['ABC130_M14_Hyb3_RC_2529_7.txt', 'ABC130_M14_Hyb4_RC_2529_7.txt']
BNL_tuned_15degrees = MultipleTestResults(in_dir + 'BNL/tuned_15degrees/', files, 'tuned_15degrees')

files = ['ABC130_M14_Hyb3_RC_2524_6.txt', 'ABC130_M14_Hyb4_RC_2524_6.txt']
BNL_tuned_17degrees = MultipleTestResults(in_dir + 'BNL/tuned_17degrees/', files, 'tuned_17degrees')

plotMultiple([SCIPP, BNL_scipp_config_15degrees], extension='GainComparisons-scippConfig')
plotMultiple([SCIPP, BNL_tuned_15degrees], extension='GainComparisons-tuned')